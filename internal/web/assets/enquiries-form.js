const initConvertModal = () => {
  const dialog = document.getElementById("convert-dialog");
  const form = document.getElementById("convert-form");
  const cancel = document.getElementById("cancel-convert");
  const search = document.getElementById("customer-search");
  const select = document.getElementById("customer-id");
  const quickName = document.getElementById("quick-customer-name");
  const quickMobile = document.getElementById("quick-customer-mobile");
  ...
  document.querySelectorAll(".open-convert-dialog").forEach((button) => {
...
const initOrderModal = () => {
  ...
  const customerMobile = document.getElementById("order-customer-mobile");
  ...
  document.querySelectorAll(".open-order-dialog").forEach((button) => {
    button.addEventListener("click", () => {
      openOrderDialog({
